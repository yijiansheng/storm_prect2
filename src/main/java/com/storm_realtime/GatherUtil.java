...
public class GatherUtil {
    ...
    public static void gatherUserData(Integer _userId, Integer _feature, Double _score
        ...
        /**
         * date:2017/12/14
         * description: < userId , < featureId , num > >
         */
     ...
     * @param dataMap
     */
    public static void gatherItemData(Integer _itemId,
                                      Integer _feature,
                                      Double _score
            , ConcurrentMap<Integer, ConcurrentMap<Integer, Double>> dataMap) {
     ...
     * < userId , < itemId , 1 > >
     */
    public static void gatherUserItemData(Integer _userId,
                                          Integer _item,
                                          ConcurrentMap<Integer, ConcurrentMap<Integer, Integer>> dataMap) {
        //如果包含用户ID
        if (dataMap.containsKey(_userId)) {
            //获取用户向量
